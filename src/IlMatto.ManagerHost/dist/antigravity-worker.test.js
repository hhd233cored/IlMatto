...
test("Antigravity coding agent uses discoverable tools and an explicit role boundary", () => {
    const settings = { sessionId: "s", workspacePath: "C:\\workspace", executionPolicy: "autonomous", mode: "implementation" };
...
test("verification worker remains sandboxed and read-only", () => {
    const settings = { sessionId: "s", workspacePath: "C:\\workspace", executionPolicy: "autonomous", mode: "verification" };
...
//# sourceMappingURL=antigravity-worker.test.js.map