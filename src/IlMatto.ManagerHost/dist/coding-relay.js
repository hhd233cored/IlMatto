export function codingRelayEnabled(mainProvider, codingProvider) {
    return mainProvider === "antigravity" && codingProvider === "codex";
}
export function buildCodingProgressPrompt(event) {
...
export function buildCodingResultPrompt(result) {
...
//# sourceMappingURL=coding-relay.js.map