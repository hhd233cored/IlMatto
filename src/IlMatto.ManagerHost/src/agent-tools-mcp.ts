...
import type { CompanionMemoryOperation, CompanionMemoryRequest, ManagerClientMessage } from "./protocol.js";
...
class ManagerRpcClient {
  ...
  private onData(chunk: string): void {
    ...
    while (newline >= 0) {
      ...
      if (message.type !== "companion_memory_response" || typeof message.requestId !== "string") continue;
