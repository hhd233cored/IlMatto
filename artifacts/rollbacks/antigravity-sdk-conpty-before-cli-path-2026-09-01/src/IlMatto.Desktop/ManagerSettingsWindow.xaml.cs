...
public partial class ManagerSettingsWindow : Window
{
    ...
    public ManagerSettingsWindow(ManagerViewModel viewModel)
    {
        ...
        AgyTimeoutBox.Text = viewModel.AntigravityTimeoutSeconds.ToString();
        ...
        AgyStatusText.Text = "新会话使用 Antigravity CLI；点击“刷新 CLI 模型”检查可用模型。";
    ...
    private void SaveButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        if (!int.TryParse(AgyTimeoutBox.Text, out var agyTimeout) || agyTimeout is < 10 or > 600 ||
            !int.TryParse(MainApiTimeoutBox.Text, out var apiTimeout) || apiTimeout is < 10 or > 600)
        {
            WpfMessageBox.Show(this, "超时必须是 10 到 600 秒之间的整数。", "IlMatto", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
        ...
        var settings = new AppSettings
        {
            ...
            DefaultCodingAgentProvider = SelectedTag(CodingProviderBox, "pi"),
